...
> lifecycle), under those repositories' own plans. The boxes below are ticked
> by outcome, checked against the `minecraft-protocol` working tree on
> 2026-08-18, not as a record that each step ran as written. Where the M1 and
> M2 plans did it differently, they are the record of how. What
...
- [x] **Step 3: Implement deterministic fetching**
...
- [x] **Step 4: Add CLI and Task commands**
...
- [x] **Step 1: Write raw-data ownership tests**
...
- [x] **Step 2: Implement raw fallback storage**
...
- [x] **Step 3: Add typed models from the manifest**
...
- [x] **Step 1: Add one fixture per ProtoDef construct**
...
- [x] **Step 3: Implement parsing without code generation**
...
- [x] **Step 4: Parse both built-in protocols**
...
- [x] **Step 1: Write golden output for representative packets**
...
- [x] **Step 2: Add shared buffer primitives**
...
- [x] **Step 3: Generate concrete codecs**
...
- [x] **Step 4: Replace Java 1.8 reflection use**
...
- [x] **Step 5: Run generator and consumer tests**
...
- [x] **Step 1: Add version assertions before generation**
...
- [x] **Step 3: Generate the version package**
...
- [x] **Step 1: Add fragmented and hostile input tests**
...
- [x] **Step 2: Implement synchronous codecs**
...
- [x] **Step 4: Run tests and fuzz smoke tests**
...
- [x] **Step 1: Write lifecycle and backpressure tests**
...
- [x] **Step 2: Implement one reader and one writer owner**
...
- [x] **Step 3: Implement explicit overload behavior**
...
- [x] **Step 4: Run race and leak tests**
...
- [x] **Step 1: Test ordering and isolation**
...
- [x] **Step 2: Implement small composable interfaces**
...
- [x] **Step 1: Write transcript tests**
...
- [x] **Step 2: Implement helpers over public interfaces**
...
- [x] **Step 3: Run transcript and race tests**
...
- [x] **Step 1: Add black-box CLI tests**
...
- [x] **Step 2: Implement subcommands**
